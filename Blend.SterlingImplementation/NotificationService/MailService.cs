...
namespace Blend.SterlingImplementation.NotificationService
{
    public class MailService : IMailService
    {
        ...
        {
            Logger.LogInfo("Sendmail", "MailProcessor Initiated");
            bool result = false;
            ...
            Logger.LogInfo("Sendmail", "Configuration settings complete");
            ...
            try
            {
                ...
                Logger.LogInfo("Sendmail", "Package Added");
            ...
            {
                Logger.LogError(ex);
                Logger.LogInfo("SendMail,Exception", ex.StackTrace);
